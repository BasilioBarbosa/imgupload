...
import { Dialog, FlatButton, TextField, TimePicker } from 'material-ui'; //material-ui //@mui/material
...
const localizer = momentLocalizer(moment) //BigCalendar.

class Calendar extends Component { //React.
    constructor() {
        super();
        this.state = {
            events: [],
    ...
    render() {
        ...
        const eventActions = [
            ...
            <FlatButton
                ...
                keyboardFocused={true}
                onClick={() => {
                    return this.deleteEvent(), this.handleClose();
                }}
            />,
            <FlatButton
                label="Confirm Edit"
                ...
                //onClick={this.handleClose}
                onClick={() => {
                    return this.updateEvent(), this.handleClose();
                }}
            />
        ];
        const appointmentActions = [
            ...
            <FlatButton
                ...
                keyboardFocused={true}
                onClick={() => {
                    return this.setNewAppointment(), this.handleClose();
                }}
            />
        ];
        return (
